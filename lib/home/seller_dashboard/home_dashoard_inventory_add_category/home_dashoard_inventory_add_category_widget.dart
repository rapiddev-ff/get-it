...
import 'home_dashoard_inventory_add_category_model.dart';
export 'home_dashoard_inventory_add_category_model.dart';
...
class _HomeDashoardInventoryAddCategoryWidgetState
  ...
  late HomeDashoardInventoryAddCategoryModel _model;
  ...
  void initState() {
    super.initState();
    _model =
        createModel(context, () => HomeDashoardInventoryAddCategoryModel());

    // On component load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.choosenCategory = widget.category;
      safeSetState(() {});
    });
  }
                      ...
                      return Column(
                        ...
                        children: [
                          InkWell(
                            ...
                            onTap: () async {
                              _model.choosenCategory = listViewCategoriesRow;
                              safeSetState(() {});
                            },
                            child: Row(
                              mainAxisSize: MainAxisSize.max,
              ...
              children: [
                Expanded(
                  child: FFButtonWidget(
                    onPressed: () async {
                      Navigator.pop(context, _model.choosenCategory);
                    },
                    text: 'Cancel',
