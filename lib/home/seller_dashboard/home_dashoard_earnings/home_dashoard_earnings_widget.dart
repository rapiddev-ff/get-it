...
import 'home_dashoard_earnings_model.dart';
export 'home_dashoard_earnings_model.dart';
...
class _HomeDashoardEarningsWidgetState
  ...
  late HomeDashoardEarningsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomeDashoardEarningsModel());
  }
                                  ...
                                  child: InkWell(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Opacity(
                                          opacity: (_model.state == 'Referrals'
                                                  ? 1
                                                  : 0)
                                              .toDouble(),
                                          child: Container(
