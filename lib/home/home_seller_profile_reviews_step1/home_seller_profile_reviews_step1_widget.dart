...
import 'home_seller_profile_reviews_step1_model.dart';
export 'home_seller_profile_reviews_step1_model.dart';
...
class _HomeSellerProfileReviewsStep1WidgetState
  ...
  late HomeSellerProfileReviewsStep1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomeSellerProfileReviewsStep1Model());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.getUserProfileWithReviews = await actions.callRpc(
        context,
                                ...
                                children: [
                                  RatingBarIndicator(
                                    ...
                                    rating: valueOrDefault<double>(
                                      valueOrDefault<int>(
                                        getJsonField(
                                          _model.getUserProfileWithReviews,
                                          r'''$.overall.avgRating''',
                                        ),
                                        0,
                                      ).toDouble(),
