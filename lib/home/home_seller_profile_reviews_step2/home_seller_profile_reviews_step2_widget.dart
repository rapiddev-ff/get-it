...
import 'home_seller_profile_reviews_step2_model.dart';
export 'home_seller_profile_reviews_step2_model.dart';
...
class _HomeSellerProfileReviewsStep2WidgetState
  ...
  late HomeSellerProfileReviewsStep2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomeSellerProfileReviewsStep2Model());
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                ...
                                if (selectedMedia != null &&
                                  ...
                                  safeSetState(() => _model
                                      .isDataUploading_uploadDataFz3 = true);
                                  ...
                                  try {
                                    ...
                                    _model.isDataUploading_uploadDataFz3 =
                                        false;
                                  }
                                  if (selectedUploadedFiles.length ==
                                      selectedMedia.length) {
                                    safeSetState(() {
                                      _model.uploadedLocalFile_uploadDataFz3 =
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          ...
                          await actions.submitReview(
                            ...
                            widget.product?.title,
                            _model.uploadReviewImages?.toList(),
                          );
                          context.safePop();
