...
class _SettingsMyProfileFollowersWidgetState
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SettingsMyProfileFollowersModel());
                            ...
                            Expanded(
                              child: Padding(
                                ...
                                child: ListView(
                                  ...
                                  children: [
                                    wrapWithModel(
                                      model: _model.followerItemModel,
                                      updateCallback: () => safeSetState(() {}),
                                      child: FollowerItemWidget(),
                                    ),
                              ...
                              child: Padding(
                                ...
                                child: ListView(
                                  ...
                                  children: [
                                    wrapWithModel(
                                      model:
                                          _model.settingsBlockedUserItemModel,
                                      updateCallback: () => safeSetState(() {}),
                                      child: SettingsBlockedUserItemWidget(),
                                    ),
                                  ].divide(SizedBox(height: 16.0)),
                                ),
                              ),
