...
export 'settings_change_password_model.dart';
...
class _SettingsChangePasswordWidgetState
    extends State<SettingsChangePasswordWidget> with TickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SettingsChangePasswordModel());
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            wrapWithModel(
                              model: _model.passwordComponentModel1,
                            ...
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  0.0, 4.0, 0.0, 0.0),
                              child: wrapWithModel(
                                model: _model.passwordComponentModel2,
                                updateCallback: () => safeSetState(() {}),
                                child: PasswordComponentWidget(
                            ...
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  0.0, 4.0, 0.0, 0.0),
                              child: wrapWithModel(
                                model: _model.passwordComponentModel3,
                                updateCallback: () => safeSetState(() {}),
                                child: PasswordComponentWidget(
                                  isActive: (String text) {
                            ...
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  0.0, 4.0, 0.0, 0.0),
                              child: wrapWithModel(
                                model: _model.passwordComponentModel4,
                                updateCallback: () => safeSetState(() {}),
                                child: PasswordComponentWidget(
                                  isActive: (String text) {
                            ...
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  0.0, 4.0, 0.0, 0.0),
                              child: wrapWithModel(
                                model: _model.passwordComponentModel5,
                                updateCallback: () => safeSetState(() {}),
                                child: PasswordComponentWidget(
