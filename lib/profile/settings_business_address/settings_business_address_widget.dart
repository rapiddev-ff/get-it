...
class SettingsBusinessAddressWidget extends StatefulWidget {
  ...
  @override
  State<SettingsBusinessAddressWidget> createState() =>
      _SettingsBusinessAddressWidgetState();
}

class _SettingsBusinessAddressWidgetState
    extends State<SettingsBusinessAddressWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SettingsBusinessAddressModel());
    ...
    _model.addressLine1TextController ??= TextEditingController(
        text: FFAppState().userData.businessAddress.addressLine1);
    ...
    _model.addressLine2TextController ??= TextEditingController(
        text: FFAppState().userData.businessAddress.addressLine2);
