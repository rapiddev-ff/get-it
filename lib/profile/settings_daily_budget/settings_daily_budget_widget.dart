...
export 'settings_daily_budget_model.dart';

class SettingsDailyBudgetWidget extends StatefulWidget {
  ...
  @override
  State<SettingsDailyBudgetWidget> createState() =>
      _SettingsDailyBudgetWidgetState();
}

class _SettingsDailyBudgetWidgetState extends State<SettingsDailyBudgetWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SettingsDailyBudgetModel());
    ...
    _model.textController ??= TextEditingController(
      ...
      formatNumber(
        FFAppState().userData.userSettings.dailyBudget,
