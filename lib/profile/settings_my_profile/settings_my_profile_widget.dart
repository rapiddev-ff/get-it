...
class SettingsMyProfileWidget extends StatefulWidget {
  ...
  @override
  State<SettingsMyProfileWidget> createState() =>
      _SettingsMyProfileWidgetState();
}

class _SettingsMyProfileWidgetState extends State<SettingsMyProfileWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SettingsMyProfileModel());
                      ...
                      Container(
                        ...
                        child: CachedNetworkImage(
                          ...
                          imageUrl: valueOrDefault<String>(
                            functions
                                .stringToImage(FFAppState().userData.avatarUrl),
                              ...
                              child: Row(
                                ...
                                children: [
                                  RatingBarIndicator(
                                    ...
                                    rating: FFAppState().userData.isSeller
                                        ? (valueOrDefault<int>(
                                            getJsonField(
                                              (_model.getReviews?.jsonBody ??
                                                  ''),
                                              r'''$.as_seller.avg_rating''',
                                            ),
                                            0,
                                          ).toDouble())
                                        : (valueOrDefault<int>(
                                  ...
                                  Text(
                                    '(${FFAppState().userData.isSeller ? valueOrDefault<String>(
                                        getJsonField(
                                          (_model.getReviews?.jsonBody ?? ''),
                                          r'''$.as_seller.total''',
                                        )?.toString(),
                          ...
                          children: [
                            ...
                            if (getJsonField(
                              ...
                              Padding(
                                ...
                                child: Builder(
                                  builder: (context) {
                                    final buyerReviews = (getJsonField(
                                          (_model.getReviews?.jsonBody ?? ''),
                                          r'''$.as_buyer.reviews''',
                                          true,
                                        )
                                    ...
                                    return ListView.separated(
                                      ...
                                      itemBuilder:
                                        ...
                                        return ReviewItemWidget(
                                          key: Key(
                                              'Keys29_${buyerReviewsIndex}_of_${buyerReviews.length}'),
                                            ...
                                            builder: (context) {
                                              ...
                                              return ListView.separated(
                                                ...
                                                itemBuilder: (context,
                                                  ...
                                                  return ReviewItemWidget(
                                                    key: Key(
                                                        'Keyh7p_${buyerReviewsIndex}_of_${buyerReviews.length}'),
                                                    reviewDataType:
                                                        buyerReviewsItem,
                                                  );
                                                },
                                            ...
                                            builder: (context) {
                                              ...
                                              return ListView.separated(
                                                ...
                                                itemBuilder: (context,
                                                  ...
                                                  return ReviewItemWidget(
                                                    key: Key(
                                                        'Key2m1_${buyerReviewsIndex}_of_${buyerReviews.length}'),
                                                    reviewDataType:
                                                        buyerReviewsItem,
                                                  );
                                                },
