...
class SettingsPaymentMethodAddWidget extends StatefulWidget {
  ...
  @override
  State<SettingsPaymentMethodAddWidget> createState() =>
      _SettingsPaymentMethodAddWidgetState();
}

class _SettingsPaymentMethodAddWidgetState
    extends State<SettingsPaymentMethodAddWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SettingsPaymentMethodAddModel());

    _model.cardNumberTextController ??= TextEditingController();
    _model.cardNumberFocusNode ??= FocusNode();
    _model.cardNumberFocusNode!.addListener(() => safeSetState(() {}));
    ...
    _model.expireDateFocusNode!.addListener(() => safeSetState(() {}));
    ...
    _model.textFieldaCVCFocusNode!.addListener(() => safeSetState(() {}));
    ...
    _model.cardholderNameFocusNode!.addListener(() => safeSetState(() {}));
                                      ...
                                      ..updatePaymentMethod(
                                        (e) => e.add(PaymentMethodStruct(
                                          ...
                                          card: PaymentCardStruct(
                                            ...
                                            expMonth: getJsonField(
                                              _model.result,
                                              r'''$.card_exp_month''',
                                            ),
                                            expYear: getJsonField(
                                              _model.result,
                                              r'''$.card_exp_year''',
                                            ),
                                          ),
                                          isDefault: getJsonField(
                                            _model.result,
                                            r'''$.is_default''',
                                          ),
