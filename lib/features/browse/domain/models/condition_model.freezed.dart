...
abstract class $ConditionCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {String id, String name, String code, String description, int sortOrder});
}
...
class _$ConditionImpl extends _Condition {
  ...
  @override
  String toString() {
    return 'Condition(id: $id, name: $name, code: $code, description: $description, sortOrder: $sortOrder)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, code, description, sortOrder);
...
abstract class _Condition extends Condition {
  const factory _Condition(
      ...
      final String code,
      final String description,
      final int sortOrder}) = _$ConditionImpl;
