...
import 'stripe_success_copy_model.dart';
export 'stripe_success_copy_model.dart';
...
class _StripeSuccessCopyWidgetState extends State<StripeSuccessCopyWidget> {
  late StripeSuccessCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StripeSuccessCopyModel());
  }
